...
get_header(); ?>
		...
		<div id="primary" class="image-attachment">
			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<nav id="nav-single">
					<h3 class="assistive-text" style="font-size:16px;margin-left:200px;"><?php _e( 'Image navigation', 'twentyeleven' ); ?></h3>
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> style="border:0px;">
						<header class="entry-header">
							<h1 class="entry-title" style="margin-left:200px">图片名称：<?php the_title(); ?></h1>

							<div class="entry-meta" style="margin-left:200px;">
								<?php
						...
						<div class="entry-content" style="margin-left: 200px;">
...
?>
							...
							<div class="entry-description" style="padding-right:140px;">
								<?php the_content(); ?>
